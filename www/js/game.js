 ...
 ***********************************************************************/
function __btn_001() { 
__sprite_init__(this, btn_001, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/btn_001_0.png']);
}; var btn_001 = new __btn_001();

function __btn_002() { 
__sprite_init__(this, btn_002, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/btn_002_0.png']);
}; var btn_002 = new __btn_002();

function __sprite_23() { 
__sprite_init__(this, sprite_23, 40, 40, 20, 20, 'Box', 20, 0, 40, 0, 40, ['img/sprite_23_0.png']);
}; var sprite_23 = new __sprite_23();

function __sprite_24() { 
__sprite_init__(this, sprite_24, 40, 40, 20, 20, 'Box', 20, 0, 40, 0, 40, ['img/sprite_24_0.png']);
}; var sprite_24 = new __sprite_24();
 ...
 * SOUNDS
 ***********************************************************************/
function __snd_button() { 
__audio_init__(this, snd_button, '', 'aud/btn_on_3.mp3', '');
}; var snd_button = new __snd_button();
 ...
 ***********************************************************************/
function __font_110() { 
__font_init__(this, font_110, 'Arial', 14, 1, 0)}; var font_110 = new __font_110();
 ...
 * OBJECTS
 ***********************************************************************/
function __obj_btn_start() {
__instance_init__(this, obj_btn_start, null, 1, 0, btn_001, 1, 0);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_btn_start)) {
...
}; var obj_btn_start = new __obj_btn_start();

function __obj_btn_load() {
__instance_init__(this, obj_btn_load, null, 1, 0, btn_002, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, obj_btn_load)) {
	sound_play(snd_button);
	sign_in();
	};
}
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_btn_load = new __obj_btn_load();

function __going() {
__instance_init__(this, going, null, 1, 0, null, 1, 4);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
__handle_sprite__(this);
with(this) {
	draw_text(room_viewport_x + 100, room_viewport_y + 16, "gogo: " + gogo);
	draw_set_font(font_110);	
}
}
};
}; var going = new __going();

function __object_25() {
__instance_init__(this, object_25, null, 1, 0, sprite_23, 1, 6);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, object_25)) {
	sound_play(snd_button);
	show_leaderboard();
	};
}
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_25 = new __object_25();

function __object_26() {
__instance_init__(this, object_26, null, 1, 0, sprite_24, 1, 7);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, object_26)) {
	sound_play(snd_button);
	submit_score();
	};
}
...
this.objects = [
[{o:obj_btn_start, x:160, y:140}],
[{o:obj_btn_load, x:160, y:220}],
[{o:going, x:160, y:80}],
[{o:object_25, x:240, y:180}],
[{o:object_26, x:80, y:180}]];
this.start = function() {
__room_start__(this, scene_3, 320, 320, 30, 128, 0, 128, null, 0, 0, 0, 320, 320, null, 50, 50);
};
}
...
cordova.plugins.playGamesServices.submitScoreNow({score: 123, leaderBoardId: "CgkIo_-***********"});
}
